...
public class MainController {
	...
	@FXML
	public void OnMenuJaccClusterOLD() {
	...
	public void OnMenuJaccCluster() {
		...
		result.ifPresent(pair -> {
			...
			crTable.getClustering().setJaccMode(mode);
			crTable.getClustering().setJaccParam(userNumber > 0 ? userNumber : 1);
	...
	public void OnMenuCosCluster() {
		...
		result.ifPresent(pair -> {
			int userNumber = pair.getKey();
			String mode = pair.getValue();
			crTable.getClustering().setCosMode(mode);
			crTable.getClustering().setCosParam(userNumber > 0 ? userNumber : 1);
			System.out.println("Zahl: " + userNumber + ", Modus: " + mode);
